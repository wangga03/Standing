        ...
        tr.innerHTML = `
            ...
            <td class="p-4 flex items-center gap-4">
                <div class="w-10 h-10 flex items-center justify-center">
                    ${team.logo ? `<img class="max-w-full max-h-full object-contain" src="${team.logo}" alt="logo">` : `<span class="material-symbols-outlined text-on-surface-variant">sports_soccer</span>`}
                </div>
